---
title: "Basic quarto tutorial for 729B"
author: "Birnir"
format: html
editor: source
...
in the text in this way.  Note to self:  This quarto tutorial builds on the github tutorial in that it creates a quarto project housed on github.  Then it goes through the creation of a quarto document.  Students will then be able to downloat the file and the source code from github.
...
I can write here a long test that is about someht
