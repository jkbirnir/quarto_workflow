...
load("~/Dropbox/Classes/2023/729B/Quarto/quarto_workflow/Indo_salary.Rdata")
...
2: Take 1 of your current projects (class or paper), that includes some figures and prefferrably some analysis and create a simple quarto file.
